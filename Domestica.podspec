#
# Be sure to run `pod lib lint Domestica.podspec' to ensure this is a
...
by broadcasting (or scanning for) UDP-layer messages
  ...
  s.homepage         = 'https://github.com/lacyrhoades/domestica'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Lacy Rhoades' => 'lacyrhoades@gmail.com' }
  s.source           = { :git => 'https://github.com/lacyrhoades/domestica.git', :tag => s.version.to_s }
