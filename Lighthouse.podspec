#
# Be sure to run `pod lib lint Lighthouse.podspec' to ensure this is a
...
by broadcasting (or scanning for) UDP-layer messages
  ...
  s.homepage         = 'https://github.com/lacyrhoades/Lighthouse'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Lacy Rhoades' => 'lacyrhoades@gmail.com' }
  s.source           = { :git => 'https://github.com/lacyrhoades/Lighthouse.git', :tag => s.version.to_s }
